...
public class CreateJava {
	...
	private static String passWord = res.getString("gpt.password");
	 ...
	 //项目跟路径路径，此处修改为你的项目路径
	private static String rootPath = "D:\\workspace-sts-3.6.4\\YIYA_MS";//getRootPath();// "F:\\openwork\\open\\";
	private static String actionPath = "D:\\workspace-sts-3.6.4\\YIYA_MS\\src\\com\\yiya\\";
	...
	public static void main(String[] args) {
		 ...
		 /** 此处修改成你的 表名 和 中文注释***/
		 String tableName="fw_product"; //
		 String codeName ="产品列表";//中文注释  当然你用英文也是可以的 
		 ...
		 String webPath = rootPath + "WebRoot\\jsp\\slicom\\"; 
